import styles from "./FreeQuote.module.less";
...
const FreeQuote = () => {
  ...
  return (
    <section className={styles.section}>
      ...
      <h2 className={styles.title}>Get Free Quote Now!</h2>
      ...
      >
        <div className={styles.form__content}>
          ...
          <input type="hidden" value="landingBottom" name="cta" />
          <label className={styles.form__content__label}>
            <input
              type="text"
